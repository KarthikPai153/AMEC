...
const institutions = [
  ...
  { id: 9, name: 'PPEC Bhadravathi(III)', website: 'https://bhadravathi.ppec.edu.in', available: true },
  { id: 10, name: 'Poornaprajna English Medium High School Adamaru', website: 'https://adamaru.ppec.edu.in', available: true },
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-red-900 to-orange-500 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Our Institutions</h1>
          <p className="text-xl max-w-3xl mx-auto">
            Explore our 24 premier institutions through our interactive wheel and discover excellence in education
          </p>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-red-900 mb-4">Interactive Institution Explorer</h2>
          <p className="text-lg text-gray-600">
            Click or hover over any segment to learn more about our institutions
          </p>
        </div>
